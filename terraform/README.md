...
* [Crear una máquina virtual con sistema operativo Ubuntu](examples/single_vm_ubuntu)
* [Crear una máquina virtual basada en CentOS Stream desde el marketplace de Azure](examples/ single_vm_centos_stream)
* [Crear una máquina virtual con dos discos: arranque + datos](examples/multiple_disks)
